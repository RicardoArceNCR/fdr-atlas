...
const TERRITORIOS = [
   ...
   */
  {
    ...
    concesion_minera: 'Se ha otorgado 1 lote de concesión minera a una empresa nicaragüense, el cual cubre el 1.02% de su territorio. Dicha concesión minera afecta de forma directa 1 río, para un total de 0.14 kilómetros de longitud de la red hídrica superficial.',
    escala: '—',
    proyeccion: 'UTM',
    datum: 'NAD 27',
    zona: '16 N',
